 ...
 * DAO for table "BSORT".
*/
public class BSortDao extends AbstractDao<BillingSort, Long> {

    public static final String TABLENAME = "BSORT";

    /**
     * Properties of entity BillingSort.<br/>
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, BillingSort entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BillingSort entity) {
        stmt.clearBindings();
    ...
    @Override
    public void readEntity(Cursor cursor, BillingSort entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BillingSort entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BillingSort entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BillingSort entity) {
